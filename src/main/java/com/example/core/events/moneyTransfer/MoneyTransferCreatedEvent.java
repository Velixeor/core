...
public class MoneyTransferCreatedEvent extends ApplicationEvent {
    private final MoneyTransferDTO moneyTransferDTO;
    private final Message message;
    public MoneyTransferCreatedEvent(Object source, MoneyTransferDTO moneyTransferDTO,Message message) {
        super(source);
